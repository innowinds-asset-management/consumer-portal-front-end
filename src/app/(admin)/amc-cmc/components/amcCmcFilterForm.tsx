...
interface AmcCmcFilterFormProps {
  onFilterChange?: (filter: ServiceContractFilter) => void;
  currentFilter?: ServiceContractFilter;
}

const AmcCmcFilterForm: React.FC<AmcCmcFilterFormProps> = ({ 
  onFilterChange, 
  currentFilter 
}) => {
          ...
          <Col md={4}>
            <Form.Group>
              <Form.Label className="fw-semibold">
                <IconifyIcon icon="solar:file-contract-bold-duotone" className="me-2" />
                Filter Type
              </Form.Label>
              <Form.Select
                value={selectedType || ''}
...
export default AmcCmcFilterForm;
